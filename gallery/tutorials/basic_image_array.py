...
noisy_imgs_copy = imgs_src.images(range(0, n_imgs))
...
fig, axs = plt.subplots(2, 2)
for i, img in enumerate(imgs_src.images(range(0, 2))):
    axs[0, i].imshow(img, cmap=plt.cm.gray)
...
colors = ["r", "g", "b", "k", "c"]
for i, img in enumerate(imgs_src.images(range(0, len(colors)))):
