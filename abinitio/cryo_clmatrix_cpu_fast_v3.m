function [clstack,corrstack,shift_equations,shift_equations_map,clstack_mask]=...
    cryo_clmatrix_cpu_fast_v3(pf,NK,verbose,max_shift,shift_step,map_filter_radius,...
...
for k1=1:n_proj
    ...
    for k2=subsetK2
        ...
        P2=proj2(1:rmax,:).';  % Take half ray plus the DC
        P2_real = real(P2);
        P2_imag = imag(P2);
        ...
        for shiftidx=1:n_shifts
            P2_shifted_flipped=bsxfun(@times,P2_flipped,all_shift_phases(:, shiftidx));
            P1_shifted_flipped=bsxfun(@times,P1_flipped,all_shift_phases(:, shiftidx));
            
            part1=P1_real*real(P2_shifted_flipped);
            part2=P1_imag*imag(P2_shifted_flipped);
            
            part1_2=P2_real*real(P1_shifted_flipped);
            part2_2=P2_imag*imag(P1_shifted_flipped);
