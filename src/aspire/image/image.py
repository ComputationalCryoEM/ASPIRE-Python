...
class Image:
    ...
    @staticmethod
    def _downsample(data, ds_res, zero_nyquist=True, legacy=False):
        """
        ...
        :return: The downsampled Image data, shape (n_imgs, ds_res, ds_res).
        """
    ...
    def downsample(self, ds_res, zero_nyquist=True, legacy=False):
        ...
        ims_ds = self._downsample(
            data, ds_res, zero_nyquist=zero_nyquist, legacy=legacy
        )
