...
class Image:
    ...
    def _im_translate(self, shifts):
        ...
        assert             n_shifts == 1 or n_shifts == self.n_images,             "number of shifts must be 1 or match the number of images"        
    ...
    def backproject(self, rot_matrices):
        ...
        assert             self.n_images == rot_matrices.shape[0],             "Number of rotation matrices must match the number of images"        
