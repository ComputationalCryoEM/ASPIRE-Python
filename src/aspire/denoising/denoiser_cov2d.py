...
class DenoiserCov2D(Denoiser):
    ...
    def build_cov2d(self, covar_opt=None, batch_size=512):
        """
    ...
    def denoise(self, istart=0, batch_size=512):
        """
        ...
        logger.info(f'Estimating Cov2D coefficients for images from {img_start} to {img_start+batch_size-1}')
