...
def _ensure_sparse_format(
    ...
    copy : boolean
        Whether a forced copy will be triggered. If copy=COPY_ME_MAYBE, a copy might
...
def check_array(
    ...
    order : 'F', 'C' or None (default=None)
        ...
        When order is None (default), then if copy=COPY_ME_MAYBE, nothing is ensured
        ...
        with warnings.catch_warnings():
            try:
                ...
                if dtype is not None and np.dtype(dtype).kind in "iu":
                    ...
                    array = array.astype(dtype, casting="unsafe", copy=COPY_ME_MAYBE)
                else:
