...
class Simulation(ImageSource):
    """
    A `Simulation` represents a synthetic dataset of realistic cryo-EM images, stored as an `Image` object.
    The images are generated by taking projections of a supplied `Volume` object, 'vols', which has first been
    rotated by the given Euler angles, 'angles'. `Filter` objects can be supplied as 'unique_filters' or
    'noise_filter' to simulate various types of corruption, such as noise or CTF filtering.
    """
