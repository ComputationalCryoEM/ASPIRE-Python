...
class ImageSource:
    ...
    def save(
        ...
        """
        Save the output metedata to STAR file and/or images to MRCS file
        ...
        """
        logger.info("save metedata into STAR file")
        self._save_metadata(
    ...
    def _save_metadata(self, starfile_filepath, batch_size=512, save_mode=None):
        """
