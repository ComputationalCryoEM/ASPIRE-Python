...
class SimTestCase(TestCase):
    ...
    def testSimulationImages(self):
        images = self.sim.clean_images(range(512)).asnumpy()
        self.assertTrue(
            np.allclose(
                images,
    ...
    def testSimulationImagesNoisy(self):
        images = self.sim.images(range(512)).asnumpy()
        self.assertTrue(
            np.allclose(
                images,
    ...
    def testSimulationImagesShape(self):
        ...
        images = self.sim.images(range(1000, 2000))
